...
(function() {
  ...
  module.exports.prototype.resolve = function () {
    return resolvers.reduce(function(r,s) { return r.then(function(e) { return Q.all(e.map(s)) }).then(function(e) { return [].concat.apply([], e)}); }, Q([1,2,3,4]))
  };
